        ...
        <div className="process-timeline">
          ...
          <div className="timeline-steps">
            ...
            <div className="timeline-step" style={{ position: 'relative', zIndex: 2 }}>
              <img src="https://slategrey-bee-869726.hostingersite.com/images/massage-hotel-cdo.png" alt="Choose Your Treatment" className="step-icon" style={{ width: '100px', height: '100px', marginBottom: '1.5rem', objectFit: 'contain', background: '#ffffff', borderRadius: '50%' }} />
            ...
            <div className="timeline-step" style={{ position: 'relative', zIndex: 2 }}>
              <img src="https://slategrey-bee-869726.hostingersite.com/images/home-massage-near-me.png" alt="Book Your Slot" className="step-icon" style={{ width: '100px', height: '100px', marginBottom: '1.5rem', objectFit: 'contain', background: '#ffffff', borderRadius: '50%' }} />
            ...
            <div className="timeline-step" style={{ position: 'relative', zIndex: 2 }}>
              <img src="https://slategrey-bee-869726.hostingersite.com/images/hotel-massage-near-me.png" alt="Enjoy Your Session" className="step-icon" style={{ width: '100px', height: '100px', marginBottom: '1.5rem', objectFit: 'contain', background: '#ffffff', borderRadius: '50%' }} />
            ...
            <div className="timeline-step" style={{ position: 'relative', zIndex: 2 }}>
              <img src="https://slategrey-bee-869726.hostingersite.com/images/massage-near-me.png" alt="Leave Refreshed" className="step-icon" style={{ width: '100px', height: '100px', marginBottom: '1.5rem', objectFit: 'contain', background: '#ffffff', borderRadius: '50%' }} />
