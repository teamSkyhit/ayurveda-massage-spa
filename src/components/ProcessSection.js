        ...
        <div className="process-timeline">
          ...
          <div className="timeline-steps">
            ...
            <div className="timeline-step" style={{ position: 'relative', zIndex: 2 }}>
              <img src="https://ayurvedaspa.ph/images/massage-hotel-cdo.png" alt="massage in cdo" className="step-icon" style={{ width: '100px', height: '100px', marginBottom: '1.5rem', objectFit: 'contain', background: '#ffffff', borderRadius: '50%' }} />
            ...
            <div className="timeline-step" style={{ position: 'relative', zIndex: 2 }}>
              <img src="https://ayurvedaspa.ph/images/home-massage-near-me.png" alt="massage spa cdo" className="step-icon" style={{ width: '100px', height: '100px', marginBottom: '1.5rem', objectFit: 'contain', background: '#ffffff', borderRadius: '50%' }} />
            ...
            <div className="timeline-step" style={{ position: 'relative', zIndex: 2 }}>
              <img src="https://ayurvedaspa.ph/images/hotel-massage-near-me.png" alt="massage spa in cdo" className="step-icon" style={{ width: '100px', height: '100px', marginBottom: '1.5rem', objectFit: 'contain', background: '#ffffff', borderRadius: '50%' }} />
            ...
            <div className="timeline-step" style={{ position: 'relative', zIndex: 2 }}>
              <img src="https://ayurvedaspa.ph/images/massage-near-me.png" alt="best massage in cdo" className="step-icon" style={{ width: '100px', height: '100px', marginBottom: '1.5rem', objectFit: 'contain', background: '#ffffff', borderRadius: '50%' }} />
