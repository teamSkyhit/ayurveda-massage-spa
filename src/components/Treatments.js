  ...
  const allTreatments = [
    {
      ...
      img: '/ayurveda-spa-massage-ayur-signature-massage.webp',
    ...
    },
    {
      ...
      img: '/ayurveda-spa-massage-hawaiian-veda-massage.webp',
    ...
    },
    {
      ...
      img: '/ayurveda-spa-massage-classic-swedish-massage.webp',
    ...
    },
    {
      ...
      img: '/ayurveda-spa-massage-royal-thai-massage.webp',
    ...
    },
    {
      ...
      img: '/ayurveda-spa-massage-deep-tissue-massage.webp',
    ...
    },
    {
      ...
      img: '/ayurveda-spa-massage-lymphatic-massage.webp',
    ...
    },
    {
      ...
      img: '/ayurveda-spa-massage-herbal-ayurvedic-massage.webp',
    ...
    },
    {
      ...
      img: '/ayurveda-spa-massage-hot-stone-massage.webp',
    ...
    },
    {
      ...
      img: '/ayurveda-spa-massage-cupping-ventosa-massage.webp',
    ...
    },
    {
      ...
      img: '/ayurveda-spa-massage-foot-hand-back-massage.webp',
    ...
    },
    {
      ...
      img: '/ayurveda-spa-massage-home-hotel-services.webp',
              ...
              >
                <div className="t-card-top" style={{ transition: 'all 0.5s cubic-bezier(0.4, 0, 0.2, 1)', flexShrink: 0 }}>
                  ...
                  <div className="t-card-bottom" style={{ maxHeight: 0, margin: 0, opacity: 0, overflow: 'hidden', transition: 'all 0.5s cubic-bezier(0.4, 0, 0.2, 1)', pointerEvents: 'none', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
                    ...
                    <div className="t-card-btn-row" style={{ display: 'flex', gap: '1rem', pointerEvents: 'auto', flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', paddingBottom: '0.5rem', paddingTop: '0.5rem' }}>
                      <a href="https://wa.link/pjquhk" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem', backgroundColor: '#113f23', color: '#fff', height: '48px', padding: '0 1.5rem', borderRadius: '50px', fontSize: '0.9rem', fontWeight: 'bold', textDecoration: 'none', transition: 'transform 0.2s ease' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>
