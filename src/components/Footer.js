  ...
  return (
    <footer className="main-footer">
      <div className="footer-bg-overlay">
        <img src="https://slategrey-bee-869726.hostingersite.com/images/ayurveda-massage-flower-img.png" alt="Decorative Flower" className="footer-bg-flower" />
      </div>
      ...
      <div className="footer-container">
        ...
        <div className="footer-col footer-col-info">
          <Link href="/">
            <img src="https://slategrey-bee-869726.hostingersite.com/images/ayurveda-massage-and--spa-logo.png" alt="Ayurveda Massage & Spa Logo" className="footer-logo" />
          </Link>
        ...
        <div className="footer-col">
          ...
          <nav className="footer-nav">
            <Link href="#" className="footer-link">Ayur Signature Massage</Link>
            <Link href="#" className="footer-link">Swedish Massage</Link>
            <Link href="#" className="footer-link">Thai Massage</Link>
            <Link href="#" className="footer-link">Hot Stone Massage</Link>
            <Link href="#" className="footer-link">View All Treatments</Link>
          </nav>
        </div>
        ...
        <div className="footer-col footer-col-contact">
          ...
          <div className="footer-socials">
            ...
            <a href="https://wa.link/xvmbyd" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="WhatsApp">
