...
import BestSpaAccordion from '../../components/BestSpaAccordion';

export const metadata = {
  title: "Best Spa in CDO | Ayurveda Massage & Spa",
  description: "Looking for the best spa in CDO? Visit Ayurveda Massage & Spa in Cagayan de Oro for Ayurvedic, Swedish, Thai, deep tissue, hot stone and relaxing massage treatments.",
  keywords: "best spa in Cagayan de Oro, best massage in CDO, massage spa in CDO, massage spa in Cagayan de Oro, spa in CDO, massage in Cagayan de Oro, spa near me, massage near me, Ayurvedic massage CDO, Thai massage CDO, Swedish massage CDO, deep tissue massage CDO, hot stone massage CDO",
};

export default function BestSpaInCDO() {
  return (
    <main className="min-h-screen flex flex-col relative" style={{ backgroundColor: '#fbf9f4' }}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          <h1 className={styles.title}>Best Spa in CDO</h1>
          ...
          <div className={styles.heroButtons}>
            <a href="https://wa.me/+639638649151" className={styles.btnSolid}>
      ...
      <section className={styles.servicesSection}>
        ...
        <div className={styles.servicesGrid}>
          ...
          <a href="https://wa.me/+639638649151" target="_blank" rel="noopener noreferrer" className={styles.serviceCard} style={{ textDecoration: 'none' }}>
          ...
          {/* Card 11 - HIGHLIGHT */}
          <a href="https://wa.me/+639638649151" target="_blank" rel="noopener noreferrer" className={`${styles.serviceCard} ${styles.serviceCardHighlight}`} style={{ textDecoration: 'none' }}>
        ...
        <a href="https://wa.me/+639638649151" target="_blank" rel="noopener noreferrer" className={styles.btnGold}>
          BOOK YOUR TREATMENT
        </a>
      </section>
        ...
        <div className={styles.bookingGrid}>
          ...
          <div className={`${styles.bookingCol} ${styles.bookingColImage}`}>
            ...
            <div className={styles.contactBtns}>
              ...
              <a href="https://wa.me/+639638649151" target="_blank" rel="noopener noreferrer" className={styles.btnContactGold}>
      ...
      <section className={styles.ctaBanner}>
        ...
        <div className={styles.ctaBtns}>
          <a href="https://wa.me/+639638649151" target="_blank" rel="noopener noreferrer" className={styles.btnCtaGold}>
